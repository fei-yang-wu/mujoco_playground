  ...
  return config_dict.create(
      ...
      obs_noise=config_dict.create(
          ...
          scales=config_dict.create(   # Reference https://www.science.org/doi/10.1126/scirobotics.adi9579
              ...
              # for ref noise
              ref_ee_pos=[0, 0.02], # m, additive, gaussian
...
class DigitRefTracking_Loco(digit_base.DigitEnv):
  ...
  def _post_init(self) -> None:
    ...
    self.kp = jp.array([
       ...
       90, 90, 120, 120, 30, 30, 60, 60, 60, 60,
       20, 20, 20, 20, #100, 200, 100, 100# 30, 50, 30, 30, # thirdarm
    ])
    self.kd = jp.array([
  ...
  def reset(self, rng: jax.Array) -> mjx_env.State:
    ...
    ref_idx = self._sample_reference(ref_rng)
    ...
    info = {
        ...
        # action info
        "act_delay_steps": self._sample_act_delay_steps(act_rng),
  ...
  def _update_done_info(self, done, info):
    ...
    # info["ref_idx"] = jp.where(done, self._sample_reference(ref_rng),info["ref_idx"])
  ...
  def _sample_reference(self, rng: jax.Array) -> jax.Array:
  ...
  def _sample_act_delay_steps(self, rng: jax.Array) -> jax.Array:
    return jax.random.randint(
       rng, 
       shape=(), 
       minval=0, 
