...
from mujoco_playground._src.locomotion.digit_v3 import ref_loader_thirdarm_4rollout_0828 as ref_loader
...
class DigitRefTracking_Loco(digit_base.DigitEnv):
  ...
  def __init__(
      ...
      task: str = "thirdarm_table_and_box",
  ...
  def reset(self, rng: jax.Array) -> mjx_env.State:
    ...
    box_pos_init = self.ref_loader.preloaded_refs["obj_pos_init"][ref_idx][0]
    box_width = self.ref_loader.preloaded_refs["obj_width"][ref_idx][0]
    qpos0 = qpos0.at[-7:-5].set(box_pos_init[:2])
