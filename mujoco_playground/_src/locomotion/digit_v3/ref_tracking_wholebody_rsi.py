...
class DigitRefTracking_Loco(digit_base.DigitEnv):
    ...
    def _update_root_state(self, info, data, rng):
        ...
        # Noise values
        info["noisy_base_robot_lin_vel"] = info["base_robot_lin_vel"] + jax.random.normal(rng,(3,)) * self._config.obs_noise.scales.base_lin_vel[1] * info["noise_level"]
        info["noisy_base_robot_ang_vel"] = info["base_robot_ang_vel"] + jax.random.normal(rng,(3,)) * self._config.obs_noise.scales.base_ang_vel[1] * info["noise_level"]
