...
from mujoco_playground._src.locomotion.digit_v3 import ref_loader_thirdarm_locomotion_rollout_0902 as ref_loader
...
class DigitRefTracking_Loco(digit_base.DigitEnv):
  ...
  def reset(self, rng: jax.Array) -> mjx_env.State:
    ...
    table_pos = self.ref_loader.preloaded_refs["table_pos"][ref_idx][0]
    qpos0 = qpos0.at[-7].set(table_pos[0]+1.4)
