...
class DigitRefTracking_Loco(digit_base.DigitEnv):
  ...
  def _get_reward(
    ...
    neg = {
        ...
        "upper_body_joint_vel_penalty": self._cost_body_joint_pos(
          info["ref_motor_joint_pos"],
          info["motor_joint_pos"]
        ),
    }
  ...
  def _cost_body_joint_vel(
    ...
    return 0.1* (left_arm_error + right_arm_error)  # Negative reward for upper body joint velocities
  ...
  def _cost_body_joint_pos(
    ...
    return 10* (left_arm_error + right_arm_error)  # Negative reward for upper body joint velocities
